    ...
    public partial class schedule : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (count == 1)
            {
                ...
                MessageBox.Show("Congratulations you are now officially fully vaccinated!");
                this.Hide();
            ...
            {
                MessageBox.Show("Either Username/Password is incorrect or it's not yet the schedule for your 2nd dose");
            }
